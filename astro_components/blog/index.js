...
const Content = () => {
    ...
    const handleDelete = async () => {
        await fetch('/api/astro/blog/delete', {
            method: 'POST',
            headers: {
    ...
    return (
        <Grid container spacing={3}>
            <Grid item xs={12}>
                <Link href="/astro/blog/create" passHref>
                                ...
                                <TableBody>
                                    {faqData.data.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => (
                                        <TableRow key={row.id}>
                                            ...
                                            <TableCell>
                                                <Link href={`/astro/blog/update/${row.id}`} passHref>
                                                ...
                                                >
                                                    ...
                                                    <DialogContent>
                                                        <DialogContentText id="alert-dialog-description">
                                                            Are you sure you want to delete Blog item with the id of {deleteId}?
                                                        </DialogContentText>
                                                    </DialogContent>
                                                    <DialogActions>
