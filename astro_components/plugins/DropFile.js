...
const DropFile = ({
    ...
    const messageError = `Cannot upload, Files must be a type  + acceptedFile}& max file ${maxSize / 1000000}Mb`;
    ...
    return (
        <div className="column">
            ...
            <div {...getRootProps({ style: noStyle ? {} : style })}>
                ...
                {!noStyle && isDragActive ? <p>Drop the files here ...</p> : !noStyle && <p>Drag drop some files here, or click to select file</p>}
            </div>
