                ...
                <Box sx={styles.htoContent}>
                    ...
                    <Grid container spacing={2} sx={styles.gridRow}>
                        ...
                        <Grid item xs={5} sx={styles.htoItemLeft}>
                            ...
                            <Typography sx={styles.htoItemDesc}>
                                Pembuatan desain akan dimulai setelah pembayaran DP diterima. Untuk desain custom (platinum) client akan mendapatkan
                                akses desainer khusus. Pengerjaan desain selesai paling lama 7 hari kerja dan revisi maksimal tanpa merubah tema
                                desain.
                            </Typography>
                        </Grid>
                    </Grid>
                    ...
                    <Grid container spacing={2} sx={styles.gridRow}>
                        ...
                        <Grid item xs={5} sx={styles.htoItemLeft}>
                            ...
                            <Typography sx={styles.htoItemDesc}>
                                ...
                                melalui email atau WA. Proses produksi ini meliputi proses persiapan pra-cetak (pembuatan plate cetak), proses cetak,
