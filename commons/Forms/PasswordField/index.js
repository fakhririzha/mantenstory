                ...
                showPasswordMeter && (
                    <>
                        <div className={styles.passwordStrength}>
                            <Typography variant="p" type="semiBold" className={styles.txtPasswdStr}>
            ...
            endAdornment={
                showVisible && (
                    <InputAdornment position="end">
                        <IconButton aria-label="toggle password visibility" onClick={() => setShow(!show)} onMouseDown={handleMouseDownPassword}>
